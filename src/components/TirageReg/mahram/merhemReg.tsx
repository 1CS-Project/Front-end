...
function MarhemReg({token,modalApi,mahremId}:props) {
    ...
    const {register,handleSubmit,setValue,formState:{errors},setError} =useForm<tirageRegT>({resolver:zodResolver(TirageRegSchema),shouldUnregister:true,defaultValues:{
