...
function contactsUs() {
  ...
  const handleLocationClick = () => {
    window.open('https://www.google.com/maps/dir/?api=1&destination=36.7670517%2C3.05123&fbclid=IwAR3SjGHi4jE_7KSy6zjMvFDByvMkhVswUtjXoH5_kiFotZx33Fwq7e25AT4'); // Replace latitude and longitude with the coordinates of your location
  };
        ...
        <div >
          ...
          <div className="flex items-center mb-6 gap-4 ">
            <svg width="67" height="68" viewBox="0 0 67 68" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <g clip-path="url(#clip0_662_8790)">
                <path d="M18.5322 34.0001C18.5322 35.9657 18.9194 37.9121 19.6716 39.7281C20.4238 41.5441 21.5264 43.1942 22.9163 44.5841C24.3062 45.974 25.9563 47.0766 27.7723 47.8288C29.5883 48.581 31.5347 48.9682 33.5003 48.9682C35.4659 48.9682 37.4123 48.581 39.2284 47.8288C41.0444 47.0766 42.6944 45.974 44.0843 44.5841C45.4743 43.1942 46.5768 41.5441 47.329 39.7281C48.0812 37.9121 48.4684 35.9657 48.4684 34.0001C48.4684 32.0344 48.0812 30.088 47.329 28.272C46.5768 26.456 45.4743 24.8059 44.0843 23.416C42.6944 22.0261 41.0444 20.9236 39.2284 20.1714C37.4123 19.4191 35.4659 19.032 33.5003 19.032C31.5347 19.032 29.5883 19.4191 27.7723 20.1714C25.9563 20.9236 24.3062 22.0261 22.9163 23.416C21.5264 24.8059 20.4238 26.456 19.6716 28.272C18.9194 30.088 18.5322 32.0344 18.5322 34.0001Z" stroke="#F5F5F5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M33.5 34H39.3209" stroke="#F5F5F5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M33.5 25.6843V33.9999" stroke="#F5F5F5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </g>
              <defs>
                <linearGradient id="paint0_linear_662_8790" x1="-38" y1="0.500001" x2="85.1895" y2="1.17936" gradientUnits="userSpaceOnUse">
                  <stop stop-color="#9B7D55" />
                  <stop offset="0.66" stop-color="#B5AC49" />
                </linearGradient>
