function Hospital() {
    return ( 
    <svg className="stroke-green-400 " width="26" height="26" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_1356_9438)">
          <path d="M4 28H28"  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path
          ...
          <path
            d="M12 28V22.6667C12 21.9594 12.281 21.2811 12.781 20.781C13.2811 20.281 13.9594 20 14.6667 20H17.3333C18.0406 20 18.7189 20.281 19.219 20.781C19.719 21.2811 20 21.9594 20 22.6667V28"
             strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M13.332 12H18.6654"  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M16 9.33398V14.6673"  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
